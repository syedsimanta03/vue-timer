<template>
  <div id="planner-header">
    ...
    <div id="planner-days">
      <div id="planner-nav">
        <button class="btn btn-default" @click="changeWeek(-1)">&lt;</button>
        <button class="btn btn-default" @click="changeWeek(0)">Today</button> 
        <button class="btn btn-default" @click="changeWeek(1)">&gt;</button>
      </div>
      <div v-for="i in 7" :key="i" class="planner-header__day">
        <div :class="{'planner-header__day-today':state.startOfWeek.clone().add(i - 1, 'days').isSame(currentDate, 'day')}">
